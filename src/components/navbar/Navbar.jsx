...
const NavComp = (p) => {
  return (
    <div className="flex items-center ml-[39px]">
      <div className="mr-[17px]">{p.img}</div>
      <div>
        <p className="text-[14px] font-[500] leading-[18px]  mb-[2px]">
          {p.header}
        </p>
        <p className="text-[14px] font-[500] leading-[18px]">{p.paragraph}</p>
      </div>
    </div>
  );
};
    ...
    <div className="text-white">
      <nav className="bg-myBlue-100  h-[160px] w-[1920px] flex items-center justify-between px-[360px] ">
        <div className=" text-[30px] font-semibold flex">
          <Logo />
          <h2 className="font-[600] text-[30px] ml-[9px] mr-[244px] p-0">
            TransitFlow
          </h2>
        </div>
        <div className="flex justify-between ">
          <NavComp
            header="Mon - Sat 9.00 - 18.00"
          ...
          <NavComp
            header="Email"
            paragraph="contact@logistics.com"
            img={
              <svg
                width="64"
                height="64"
      ...
      <nav className="h-[78px] w-[1920px] absolute top-[160px] z-20 bg-blue-900 bg-opacity-25 flex items-center justify-between px-[360px]">
        <div>
          <ul className="flex justify-between items-center navul">
            Home
            <li className="relative">
              <div className="border-b-[2px] text-center border-white w-[43px] absolute top-[35px] left-[-43px]"></div>
            </li>
            <span className="border-r-[2px]  opacity-20 h-[19px] mx-[30px]"></span>
            <li>About</li>
            <span className="border-r-[2px]  opacity-20 h-[19px] mx-[30px]"></span>
        ...
        <div className="flex items-center ">
          ...
          <button className="bg-white text-black px-[52px] py-[28px] ml-[50px]">
            Request Quote
          </button>
        </div>
      </nav>
